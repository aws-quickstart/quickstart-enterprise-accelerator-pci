...
:partner-product-name: Standardized Architecture for PCI DSS 
...
:quickstart-contributors: Andrew Glenn, Tony Bulding, AWS Envision Engineering, AWS Professional Services, AWS Quick Start team
